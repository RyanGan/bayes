...
data_5.3 <- 
  read.csv('./bayes_stats_modeling/05-glm/data/data-shopping-2.csv') %>% 
...
model.5.4 = cmdstan_model(
  stan_file = './bayes_stats_modeling/05-glm/stan/model5-4.stan'
  )
...
data_5.4 <- read.csv('./bayes_stats_modeling/05-glm/data/data-shopping-3.csv')
...
q[v] = logit^{-1}(b_1 + b_2Sex[v] + b_3Income[v] + b_4Discount[v]) \\
Y[v] \backsim Bernoulli(q[v])
...
model.5.5 = cmdstan_model(
  stan_file = './bayes_stats_modeling/05-glm/stan/model5-5.stan'
  )
